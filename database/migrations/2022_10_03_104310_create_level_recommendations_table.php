...
class CreateLevelRecommendationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('level_recommendations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('level_recommendations');
    }
}
